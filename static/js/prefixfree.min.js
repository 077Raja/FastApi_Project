    ...
    if (window.StyleFix && window.getComputedStyle) {
        var t = window.PrefixFree = {
            prefixCSS: function(e, n) {
                ...
                return n && (e = r("selectors", "", "\\b", t.prefixSelector, e), e = r("atrules", "@", "\\b", "@" + i + "$1", e)), e = e.replace(RegExp("-" + i, "g"), "-"), e = e.replace(/-\*-(?=[a-z]+)/gi, t.prefix), e = e.replace(/-\*-/, t.prefix), e = e.replace(/(^\*:|(?=[\s\{\};]))-(?=[a-z])/gi, t.prefix), e
            },
            property: function(e) {
                return t.prefix + e
            },
        ...
        ! function() {
            ...
            for (var a in r) {
                var o = a + (r[a] ? "(" + r[a] + ")" : "");
                !e(o) && e(t.prefixSelector(o)) && t.selectors.push(a)
            }
            for (var s in n) {
                var o = s + " " + (n[s] || "");
                !e("@" + o) && e("@" + t.prefix + o) && t.atrules.push(s)
            }
            e.removeChild(i)
